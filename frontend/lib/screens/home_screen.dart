...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Map<String, String>> _steps = [
    ...
    },
    {
      ...
      'subtitle':
          'Scan Qr Code generated by lcd screen to get available locker',
    },
    {
      'image': 'assets/steps/step3.jpg',
      'title': '3. Scan Package',
    ...
    _autoScrollTimer = Timer.periodic(_autoScrollDuration, (timer) {
      if (_pageController.hasClients) {
        ...
        if (nextPage < _steps.length) {
          ...
          // Animate to first page for smooth looping
          _pageController.animateToPage(
            0,
            duration: const Duration(milliseconds: 500),
            curve: Curves.easeInOut,
  ...
  void _onScanPressed() async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => const InputDetailsScreen(lockerId: null),
      ),
    );
  }
